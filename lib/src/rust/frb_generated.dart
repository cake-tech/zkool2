...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1398924101;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<int> crateApiPayGetCoinSelectionMode({required Coin c});
  ...
  Future<List<String>> crateApiAccountListOwnedAddresses({required Coin c});
  ...
  Stream<MigrationStatus> crateApiMigrateRunMigration(
  ...
  Future<void> crateApiPaySetCoinSelectionMode(
      {required int mode, required Coin c});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<int> crateApiPayGetCoinSelectionMode({required Coin c}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiPayGetCoinSelectionModeConstMeta,
        argValues: [c],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPayGetCoinSelectionModeConstMeta =>
      const TaskConstMeta(
        debugName: "get_coin_selection_mode",
        argNames: ["c"],
      );
  ...
  Future<List<String>> crateApiAccountListOwnedAddresses({required Coin c}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAccountListOwnedAddressesConstMeta,
        argValues: [c],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAccountListOwnedAddressesConstMeta =>
      const TaskConstMeta(
        debugName: "list_owned_addresses",
        argNames: ["c"],
      );
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta: kCrateApiMigrateRunMigrationConstMeta,
          argValues: [sink, c, meanDelayMs],
          apiImpl: this,
        ),
      ),
    );
  ...
  TaskConstMeta get kCrateApiMigrateRunMigrationConstMeta =>
      const TaskConstMeta(
        debugName: "run_migration",
        argNames: ["sink", "c", "meanDelayMs"],
      );
  ...
  Future<void> crateApiPaySetCoinSelectionMode(
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiPaySetCoinSelectionModeConstMeta,
        argValues: [mode, c],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPaySetCoinSelectionModeConstMeta =>
      const TaskConstMeta(
        debugName: "set_coin_selection_mode",
        argNames: ["mode", "c"],
      );
