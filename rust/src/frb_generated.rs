...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1910033674;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        48 => wire__crate__api__account__get_account_fingerprint_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        49 => wire__crate__api__account__get_account_frost_params_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        50 => wire__crate__api__account__get_account_pools_impl(port, ptr, rust_vec_len, data_len),
        51 => wire__crate__api__account__get_account_seed_impl(port, ptr, rust_vec_len, data_len),
        52 => wire__crate__api__account__get_account_ufvk_impl(port, ptr, rust_vec_len, data_len),
        53 => wire__crate__api__account__get_addresses_impl(port, ptr, rust_vec_len, data_len),
        54 => {
            wire__crate__api__network__get_coingecko_price_impl(port, ptr, rust_vec_len, data_len)
        }
        55 => wire__crate__api__network__get_current_height_impl(port, ptr, rust_vec_len, data_len),
        56 => wire__crate__api__sync__get_db_height_impl(port, ptr, rust_vec_len, data_len),
        57 => wire__crate__api__frost__get_dkg_addresses_impl(port, ptr, rust_vec_len, data_len),
        58 => wire__crate__api__account__get_exported_data_impl(port, ptr, rust_vec_len, data_len),
        60 => wire__crate__api__mempool__get_mempool_tx_impl(port, ptr, rust_vec_len, data_len),
        61 => wire__crate__api__network__get_network_name_impl(port, ptr, rust_vec_len, data_len),
        62 => wire__crate__api__db__get_prop_impl(port, ptr, rust_vec_len, data_len),
        64 => wire__crate__api__coin__get_tor_client_impl(port, ptr, rust_vec_len, data_len),
        65 => wire__crate__api__account__get_tx_details_impl(port, ptr, rust_vec_len, data_len),
        66 => wire__crate__api__frost__has_dkg_addresses_impl(port, ptr, rust_vec_len, data_len),
        67 => wire__crate__api__frost__has_dkg_params_impl(port, ptr, rust_vec_len, data_len),
        68 => wire__crate__api__account__has_transparent_pub_key_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        69 => wire__crate__api__account__import_account_impl(port, ptr, rust_vec_len, data_len),
        70 => wire__crate__api__init__init_app_impl(port, ptr, rust_vec_len, data_len),
        71 => wire__crate__api__raptor__init_app_impl(port, ptr, rust_vec_len, data_len),
        72 => wire__crate__api__coin__init_datadir_impl(port, ptr, rust_vec_len, data_len),
        73 => wire__crate__api__network__init_datadir_impl(port, ptr, rust_vec_len, data_len),
        74 => wire__crate__api__frost__init_dkg_impl(port, ptr, rust_vec_len, data_len),
        75 => wire__crate__api__frost__init_sign_impl(port, ptr, rust_vec_len, data_len),
        76 => wire__crate__api__vault__init_vault_impl(port, ptr, rust_vec_len, data_len),
        77 => {
            wire__crate__api__frost__is_signing_in_progress_impl(port, ptr, rust_vec_len, data_len)
        }
        84 => wire__crate__api__issuance__issue_asset_impl(port, ptr, rust_vec_len, data_len),
        85 => wire__crate__api__account__list_accounts_impl(port, ptr, rust_vec_len, data_len),
        86 => wire__crate__api__account__list_categories_impl(port, ptr, rust_vec_len, data_len),
        87 => wire__crate__api__db__list_db_names_impl(port, ptr, rust_vec_len, data_len),
        88 => wire__crate__api__account__list_folders_impl(port, ptr, rust_vec_len, data_len),
        89 => wire__crate__api__account__list_memos_impl(port, ptr, rust_vec_len, data_len),
        90 => wire__crate__api__account__list_notes_impl(port, ptr, rust_vec_len, data_len),
        91 => wire__crate__api__account__list_tx_history_impl(port, ptr, rust_vec_len, data_len),
        92 => wire__crate__api__zsa__list_zsa_holdings_impl(port, ptr, rust_vec_len, data_len),
        93 => wire__crate__api__account__lock_note_impl(port, ptr, rust_vec_len, data_len),
        94 => wire__crate__api__account__lock_recent_notes_impl(port, ptr, rust_vec_len, data_len),
        95 => wire__crate__api__account__max_spendable_impl(port, ptr, rust_vec_len, data_len),
        96 => wire__crate__api__account__new_account_impl(port, ptr, rust_vec_len, data_len),
        97 => wire__crate__api__pay__pack_transaction_impl(port, ptr, rust_vec_len, data_len),
        99 => wire__crate__api__pay__prepare_impl(port, ptr, rust_vec_len, data_len),
        100 => wire__crate__api__account__print_keys_impl(port, ptr, rust_vec_len, data_len),
        101 => wire__crate__api__db__put_prop_impl(port, ptr, rust_vec_len, data_len),
        102 => wire__crate__api__account__receivers_default_impl(port, ptr, rust_vec_len, data_len),
        104 => wire__crate__api__account__remove_account_impl(port, ptr, rust_vec_len, data_len),
        105 => wire__crate__api__account__rename_category_impl(port, ptr, rust_vec_len, data_len),
        106 => wire__crate__api__account__rename_folder_impl(port, ptr, rust_vec_len, data_len),
        107 => wire__crate__api__account__reorder_account_impl(port, ptr, rust_vec_len, data_len),
        108 => wire__crate__api__frost__reset_sign_impl(port, ptr, rust_vec_len, data_len),
        109 => wire__crate__api__account__reset_sync_impl(port, ptr, rust_vec_len, data_len),
        110 => wire__crate__api__sync__rewind_sync_impl(port, ptr, rust_vec_len, data_len),
        111 => wire__crate__api__pay__send_impl(port, ptr, rust_vec_len, data_len),
        112 => wire__crate__api__zsa__set_asset_name_impl(port, ptr, rust_vec_len, data_len),
        113 => wire__crate__api__frost__set_dkg_address_impl(port, ptr, rust_vec_len, data_len),
        114 => wire__crate__api__frost__set_dkg_params_impl(port, ptr, rust_vec_len, data_len),
        116 => {
            wire__crate__api__transaction__set_tx_category_impl(port, ptr, rust_vec_len, data_len)
        }
        117 => wire__crate__api__transaction__set_tx_price_impl(port, ptr, rust_vec_len, data_len),
        118 => wire__crate__api__account__show_ledger_sapling_address_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        119 => wire__crate__api__account__show_ledger_transparent_address_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        120 => wire__crate__api__account__sign_ledger_transaction_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        121 => wire__crate__api__pay__sign_transaction_impl(port, ptr, rust_vec_len, data_len),
        122 => wire__crate__api__pay__store_pending_tx_impl(port, ptr, rust_vec_len, data_len),
        123 => wire__crate__api__sync__synchronize_impl(port, ptr, rust_vec_len, data_len),
        125 => {
            wire__crate__api__account__tx_account_default_impl(port, ptr, rust_vec_len, data_len)
        }
        126 => wire__crate__api__account__tx_memo_default_impl(port, ptr, rust_vec_len, data_len),
        127 => wire__crate__api__account__tx_note_default_impl(port, ptr, rust_vec_len, data_len),
        128 => wire__crate__api__account__tx_output_default_impl(port, ptr, rust_vec_len, data_len),
        129 => wire__crate__api__account__tx_spend_default_impl(port, ptr, rust_vec_len, data_len),
        131 => wire__crate__api__account__unlock_all_notes_impl(port, ptr, rust_vec_len, data_len),
        132 => wire__crate__api__pay__unpack_transaction_impl(port, ptr, rust_vec_len, data_len),
        133 => wire__crate__api__account__update_account_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        59 => wire__crate__api__key__get_key_pools_impl(ptr, rust_vec_len, data_len),
        63 => wire__crate__api__raptor__get_qr_bytes_impl(ptr, rust_vec_len, data_len),
        78 => wire__crate__api__key__is_tex_address_impl(ptr, rust_vec_len, data_len),
        79 => wire__crate__api__key__is_valid_address_impl(ptr, rust_vec_len, data_len),
        80 => wire__crate__api__key__is_valid_fvk_impl(ptr, rust_vec_len, data_len),
        81 => wire__crate__api__key__is_valid_key_impl(ptr, rust_vec_len, data_len),
        82 => wire__crate__api__key__is_valid_phrase_impl(ptr, rust_vec_len, data_len),
        83 => wire__crate__api__key__is_valid_transparent_address_impl(ptr, rust_vec_len, data_len),
        98 => wire__crate__api__pay__parse_payment_uri_impl(ptr, rust_vec_len, data_len),
        103 => wire__crate__api__account__receivers_from_ua_impl(ptr, rust_vec_len, data_len),
        115 => wire__crate__api__init__set_log_stream_impl(ptr, rust_vec_len, data_len),
        124 => wire__crate__api__pay__to_plan_impl(ptr, rust_vec_len, data_len),
        130 => wire__crate__api__account__ua_from_ufvk_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
